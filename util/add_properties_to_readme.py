...
***REMOVED***Script to generate content for the Available Properties header in the README.
***REMOVED***Generates a file which can then be copied into the README. Be sure to move this

...
def logout():
    ...
    # nullify all the info both in Neo4j and stored in the UI for this session
...
def get_cart_metadata():
    string = 'sample_id\tsubject_id\tsample_body_site\tsubject_gender\tvisit_number\tsubject_race\tstudy_full_name\tproject_name' # header
